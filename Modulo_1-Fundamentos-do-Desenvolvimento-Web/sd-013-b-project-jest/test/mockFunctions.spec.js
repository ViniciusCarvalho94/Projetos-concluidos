...
describe('verifica as funções e os mocks', () => {
  ...
  // função retirada do site https://javascript.info/task/factorial
  mockFunctions.factorial.mockImplementation(function (a) {
    return a ? a * mockFunctions.factorial(a - 1) : 1;
  });
